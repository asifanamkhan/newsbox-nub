...
<div class="container-fluid bg-dark pt-5 px-sm-3 px-md-5 mt-5">
    <div class="row py-4">
        <div class="col-lg-3 col-md-6 mb-5">
            <h5 class="mb-4 text-white text-uppercase font-weight-bold">Top News</h5>
        ...
        <div class="col-lg-6 col-md-6 mb-5">
            ...
            <div class="row">
                <div class="col-3 mb-3">
                    <a href=""><img class="w-75" src="{{asset('public/front-end/img/news-110x110-1.jpg')}}" alt=""></a>
                </div>
                <div class="col-3 mb-3">
                    <a href=""><img class="w-75" src="{{asset('public/front-end/img/news-110x110-2.jpg')}}" alt=""></a>
                </div>
                <div class="col-3 mb-3">
                    <a href=""><img class="w-75" src="{{asset('public/front-end/img/news-110x110-3.jpg')}}" alt=""></a>
                </div>
                <div class="col-3 mb-3">
                    <a href=""><img class="w-75" src="{{asset('public/front-end/img/news-110x110-4.jpg')}}" alt=""></a>
                </div>
                <div class="col-3 mb-3">
                    <a href=""><img class="w-75" src="{{asset('public/front-end/img/news-110x110-5.jpg')}}" alt=""></a>
                </div>
                <div class="col-3 mb-3">
                    <a href=""><img class="w-75" src="{{asset('public/front-end/img/news-110x110-1.jpg')}}" alt=""></a>
                </div>
