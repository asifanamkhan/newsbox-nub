...
@section('content')
    ...
    <div class="box">
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-7">
                    <form id="create_form" action="{{route('notice.update', $notice->id)}}" method="post">
                        @csrf
                        @method('PUT')
                        <div id="img-body">
                            <input type="hidden" name="image" id="image">
                            <input type="hidden" name="old_image" id="" value="{{$notice->image}}">
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="description" id="" cols="30" class="form-control tinymce-editor" rows="10">{!! $notice->description !!}</textarea>
                        </div>
                        <div class="form-group col-md-12">
                ...
                <div class="col-md-5">
                   <div>
                       ...
                       <img  src="{{asset($notice->image)}}" alt="" class="img-fluid rounded img-thumbnail">
