...
<link rel="stylesheet" href="{{asset('back-end/css/_all-skins.min.css')}}">
<!-- Morris chart -->
<link rel="stylesheet" href="{{asset('back-end/css/morris.css')}}">
<!-- jvectormap -->
<link rel="stylesheet" href="{{asset('back-end/css/jquery-jvectormap.css')}}">
<!-- Date Picker -->
<link rel="stylesheet" href="{{asset('back-end/css/bootstrap-datepicker.min.css')}}">
<!-- Daterange picker -->
<link rel="stylesheet" href="{{asset('back-end/css/daterangepicker.css')}}">

<!-- DataTables -->
<link rel="stylesheet" href="{{asset('back-end/css/dataTables.bootstrap.min.css')}}">

<!-- Select2 -->
<link rel="stylesheet" href="{{asset('back-end/css/select2.min.css')}}">
